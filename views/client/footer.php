                    ...
                    <div class="axil-footer-widget">
                        ...
                        <div class="inner">
                            ...
                            <div class="download-btn-group">
                                <div class="qr-code">
                                    <img src="<?= ROOT_URL . 'views/client/assets/images/others/qr.png' ?>" alt="Axilthemes">
                                </div>
                                <div class="app-link">
                                    <a href="#">
                                        <img src="<?= ROOT_URL . 'views/client/assets/images/others/app-store.png' ?>" alt="App Store">
                                    </a>
                                    <a href="#">
                                        <img src="<?= ROOT_URL . 'views/client/assets/images/others/play-store.png' ?>" alt="Play Store">
                                    </a>
                                </div>
                            </div>
                        </div>
...
<div class="header-search-modal" id="header-search-modal">
    ...
    <div class="header-search-wrap">
        <div class="card-header">
            <form role="search">
                <div class="input-group">
                    <input type="search" class="form-control" id="keyword" placeholder="Search..." />
        ...
        <div class="card-body">
            ...
            <div class="psearch-results" id="searchResults">
                <!-- Ket qua tim kiem -->
            </div>
        </div>
    </div>
...
<script>
    ...
    function performSearch() {
        ...
        if (searchValue === "") {
            searchResults.innerHTML = "<p>Nhập tên sản phẩm để tìm kiếm.</p>";
            return;
        }

        // Gửi yêu cầu AJAX
        fetch("<?= ROOT_URL . '?ctl=search' ?>", {
                method: "POST", // Hoặc "GET" nếu cần
                headers: {
                    "Content-Type": "application/x-www-form-urlencoded",
                },
                body: "keyword=" + encodeURIComponent(searchValue),
            })
            .then((response) => response.text())
            .then((data) => {
                // Cập nhật nội dung của psearch-results
                searchResults.innerHTML = data;
            })
            .catch((error) => {
                console.error("Error:", error);
                searchResults.innerHTML = "<p>Error occurred. Please try again.</p>";
            });
    }
