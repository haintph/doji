                ...
                <div class="row align-items-center">
                    <div class="col-xl-4 col-lg-6">
                        <div class="about-thumbnail">
                            <div class="thumbnail">
                                <img src="<?= ROOT_URL . 'views/client/assets/images/about/about-01.png'?>" alt="About Us">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row row--20">
                    <div class="col-lg-4">
                        <div class="about-info-box">
                            <div class="thumb">
                                <img src="<?= ROOT_URL . 'views/client/assets/images/about/shape-01.png'?>" alt="Shape">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4">
                        <div class="about-info-box">
                            <div class="thumb">
                                <img src="<?= ROOT_URL . 'views/client/assets/images/about/shape-02.png' ?>" alt="Shape">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4">
                        <div class="about-info-box">
                            <div class="thumb">
                                <img src="<?= ROOT_URL . 'views/client/assets/images/about/shape-03.png' ?>" alt="Shape">
                            </div>
                            <div class="content">
                    ...
                    <div class="team-slide-activation slick-layout-wrapper--20 axil-slick-arrow  arrow-top-slide">
                        <div class="slick-single-layout">
                            <div class="axil-team-member">
                                <div class="thumbnail"><img src="<?= ROOT_URL . 'views/client/assets/images/team/team-01.png'?>" alt="Cody Fisher"></div>
                        ...
                        <div class="slick-single-layout">
                            <div class="axil-team-member">
                                <div class="thumbnail"><img src="<?= ROOT_URL . 'views/client/assets/images/team/team-03.png'?>" alt="Cody Fisher"></div>
                                <div class="team-content">
                        ...
                        <div class="slick-single-layout">
                            <div class="axil-team-member">
                                <div class="thumbnail"><img src="<?= ROOT_URL . 'views/client/assets/images/team/team-04.png'?>" alt="Cody Fisher"></div>
                                <div class="team-content">
                                    <span class="subtitle">Designer</span>
                                    <h5 class="title">Alonso M. Miklonax</h5>
                                </div>
                        ...
                        <div class="slick-single-layout">
                            <div class="axil-team-member">
                                <div class="thumbnail"><img src="<?= ROOT_URL . 'views/client/assets/images/team/team-02.png'?>" alt="Cody Fisher"></div>
                                <div class="team-content">
                                    <span class="subtitle">Designer</span>
                                    <h5 class="title">Alonso M. Miklonax</h5>
                                </div>
